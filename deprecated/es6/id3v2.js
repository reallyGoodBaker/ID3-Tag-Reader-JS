import {Byte, BytesStream} from './binary-operate/bytes.js';
import {UTF16Buffer, UTF8Buffer} from './binary-operate/string_decode.js';
...
const parsers = {
      ...
      APIC: function (data) {//255, 216
            ...
            return {
                  ...
                  img.src = 'data:image/jpeg;base64,' + this.blob;
                  return img;
            }};
      },
